...
<body>
  <section class="min-h-screen flex items-stretch text-white ">
    <div class="bg-gray-100 text-gray-500 rounded shadow-xl w-full overflow-hidden" style="height:100vh!imprtant;">
      <div class="md:flex w-full">
        <div class="w-3/6 bg-indigo-500 py-10 px-10">
        ...
        <form id="form" action="#" class="w-full sm:w-3/6 p-5">
          <div class="text-center mb-6">
            <h1 class="font-bold text-3xl text-slate-600"> create your account</h1>
         </div>
          <div class="flex items-center space-x-3 w-full">
          <div class="input-control flex-auto">
            <label for="first_name">First name</label>
            <input onKeyup="validateInputs('first_name')" id="first_name" name="first_name" type="text">
            <div class="error"></div>
          </div>
          <div class="input-control flex-auto">
            <label for="last_name">Last name</label>
            <input onKeyup="validateInputs('last_name')" id="last_name" name="last_name" type="text">
            <div class="error"></div>
          </div>
          </div>
          <div class="input-control">
            <label for="username">Username</label>
            <input onKeyup="validateInputs('username')" id="username" name="username" type="text">
            <div class="error"></div>
          </div>
          <div class="input-control">
            <label for="email">Email</label>
            <input onKeyup="validateInputs('email')" id="email" name="email" type="text">
            <div class="error"></div>
          </div>
          <div class="input-control">
            <label for="password">Password</label>
            <input onKeyup="validateInputs('password')" id="password" name="password" type="password">
            <div class="error"></div>
          </div>
          <div class="input-control">
            <label for="password2">Password again</label>
            <input onKeyup="validateInputs('confirm_password')" id="password2" name="password2" type="password">
            <div class="error"></div>
          </div>
